...
#                'capacity_mbps_km2': datum['capacity_mbps_km2'],
                'path_loss': [datum[x]['path_loss'] for x in range(len(datum))],
                'received_power': [datum[x]['received_power'] for x in range(len(datum))],
                'interference': [datum[x]['interference'] for x in range(len(datum))],
                'sinr': [datum[x]['sinr'] for x in range(len(datum))],
                'spectral_efficiency': [datum[x]['spectral_efficiency'] for x in range(len(datum))],
                'capacity_mbps': [datum[x]['capacity_mbps'] for x in range(len(datum))],
                'capacity_mbps_km2': [datum[x]['capacity_mbps_km2'] for x in range(len(datum))],
                'strategy': strategy,
